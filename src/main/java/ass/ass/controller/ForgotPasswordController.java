...
public class ForgotPasswordController {
    ...
    public String showForgotPasswordForm(Model model, HttpSession session) {
        return "index/nopass"; // Trả về form quên mật khẩu
    }
    ...
    public String handleForgotPassword(@RequestParam("email") String email, Model model, HttpSession session) {
        ...
        return "index/nopass"; // Trả về form với thông báo
    }

    // Phương thức tiện ích để tìm account theo email (tùy chọn nếu repository chưa có)
